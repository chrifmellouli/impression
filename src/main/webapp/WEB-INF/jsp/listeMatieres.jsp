	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<hr>
				<form action="/Matieres/ajouterMatiere">
					<div class="form-group">
						<br>
						<hr>
						<label for="sub">Liste Des Matieres</label> <input name="sub"
						...
						<tbody>
							<c:forEach items="${matieres}" var="matiere">
								<tr>
									...
									<td>${matiere.nombreDesEtudiants}</td>
									<td><form
											action="/Matieres/${matiere.idMatiere}/ModifierMatiere">
									...
									<td>
										<form
											action="/Matieres/${matiere.idMatiere}/Supprimer">
