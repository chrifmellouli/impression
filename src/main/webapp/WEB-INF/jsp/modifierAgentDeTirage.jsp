...
<title>Modifier un agent de tirage</title>
	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<hr>
				<form class="form-horizontal" action="ModifierAgentDeTirage/Modifier">
					<fieldset>
						<!-- Form Name -->
						<legend>Modifier Un Agent De Tirage</legend>
						<!-- Text input-->
						<div class="form-group">
							<label class="col-md-4 control-label" for="id">ID</label>
							<div class="col-md-5">
								<input id="id" name="id" type="text"
									placeholder="ID de l'agent" class="form-control input-md"
									required="required" value="${agentDeTirage.idAgentDeTirage}">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-5">
								<input id="nom" name="nom" type="text"
									...
									required="required" value="${agentDeTirage.nom}">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-md-5">
								<input id="motdepasse" name="motdepasse" type="password"
									...
									class="form-control input-md" required="required"
									value="${agentDeTirage.motDePasse}">
							</div>
						</div>
						<!-- Button (Double) -->
						<div class="form-group">
