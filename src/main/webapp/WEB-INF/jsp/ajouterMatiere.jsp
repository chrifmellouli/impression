	...
	<div class="container">
		<div class="row">
			<div class="col-md-12">
				...
				<hr>
				<form class="form-horizontal" action="/Matieres/ajouterMatiere/Ajouter"
					method="post">
					<fieldset>
						<!-- Form Name -->
						<legend>Ajouter Une Matiere</legend>
						<!-- Text input-->
						<div class="form-group">
							<label class="col-md-4 control-label" for="designation">Designation</label>
							<div class="col-md-5">
								<input id="designation" name="designation" type="text"
									placeholder="Designation de la matière" class="form-control input-md"
									required="required">
							</div>
						</div>
						<!-- Text input-->
						<div class="form-group">
							...
							<div class="col-md-5">
								<input id="nombredesetudiants" name="nombredesetudiants" type="text"
									placeholder="Nombre des etudiants de la matière"
